...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--rps", type=int, default=1000, help="Target requests per second (default: 1000)")
    p.add_argument("--concurrency", type=int, default=500, help="Max concurrent in-flight requests (default: 500)")
